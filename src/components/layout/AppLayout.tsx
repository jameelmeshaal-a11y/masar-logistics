    ...
    <>
      ...
      <aside className={`fixed top-0 right-0 h-full bg-sidebar z-50 transition-all duration-300 flex flex-col
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-sidebar-border">
          ...
          <div>
            <h1 className="text-base font-bold text-sidebar-foreground font-heading">مسار الخدمات اللوجستية</h1>
            <p className="text-[11px] text-sidebar-muted">Masar Logistics</p>
          </div>
